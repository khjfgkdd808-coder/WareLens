...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    price: 29000, colors: ['#B0C4DE', '#FFFFFF'], season: 'spring',
  ...
  },
  {
    ...
    price: 19000, colors: ['#FFFFFF', '#000000', '#6B7280'], season: 'summer',
  ...
  },
  {
    ...
    price: 24000, colors: ['#1C1C1C', '#FFFFFF'], season: 'fall',
  ...
  },
  {
    ...
    price: 45000, colors: ['#F5F5DC', '#C8A882'], season: 'winter',
  ...
  },
  {
    ...
    price: 38000, colors: ['#87CEEB', '#FFFFFF'], season: 'spring',
  ...
  },
  {
    ...
    price: 22000, colors: ['#708090', '#4A5568'], season: 'summer',
    similarityScore: 79, recommendBadges: ['상체 밸런스 조절'],
    fitPosition: { top: '18%', left: '10%', width: '80%' },
  },
  {
    id: '7', name: '플리스 집업 스웨터', category: '니트/스웨터',
    imageUrl: 'https://images.unsplash.com/photo-1556821840-3a63f15732ce?w=400&q=80',
    price: 52000, colors: ['#2D3748', '#4A5568'], season: 'winter',
    similarityScore: 76, recommendBadges: ['어깨 비율 보완'],
  },
  {
    id: '8', name: '쿨링 반팔 폴로', category: '반팔 티셔츠',
    imageUrl: 'https://images.unsplash.com/photo-1626497764746-6dc36546b388?w=400&q=80',
    price: 31000, colors: ['#FFFFFF', '#F0F4F8'], season: 'summer',
    similarityScore: 74, recommendBadges: ['체형 적합', '색상 유사'],
  },
  {
    id: '9', name: '체크 플란넬 셔츠', category: '셔츠/블라우스',
    imageUrl: 'https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=400&q=80',
    price: 42000, colors: ['#8B2500', '#2D3748'], season: 'fall',
    similarityScore: 72, recommendBadges: ['스타일 유사'],
  },
  {
    id: '10', name: '롤넥 울 스웨터', category: '니트/스웨터',
    imageUrl: 'https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=400&q=80',
    price: 67000, colors: ['#1A1A2E', '#F5F5DC'], season: 'winter',
    similarityScore: 70, recommendBadges: ['상체 밸런스 조절', '색상 유사'],
  },
  {
    id: '11', name: '슬림핏 긴팔 라운드', category: '긴팔 티셔츠',
    imageUrl: 'https://images.unsplash.com/photo-1503341504253-dff4815485f1?w=400&q=80',
    price: 21000, colors: ['#2C3E50', '#95A5A6'], season: 'fall',
    similarityScore: 68, recommendBadges: ['체형 적합'],
  },
  {
    id: '12', name: '와플 텍스처 반팔', category: '반팔 티셔츠',
    imageUrl: 'https://images.unsplash.com/photo-1622445275463-afa2ab738c34?w=400&q=80',
    price: 25000, colors: ['#F5CBA7', '#FAD7A0'], season: 'spring',
    similarityScore: 65, recommendBadges: ['색상 유사'],
  },
]
